...
<!--				<div class="order-lg-last">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="doctor_home.jsp" class="nav-link">Home</a></li>
	        	
	        	<li class="nav-item"><a href="add_report.jsp" class="nav-link">Add Report</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="doctor_home.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span><%=Logic.info.pname%> <i class="fa fa-chevron-right"></i></span></p>
							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Add Report</h3>
										<form action="./upload_pdf" method="POST"   enctype="multipart/form-data" id="contactForm" class="contactForm">
											<div class="row">
													...
													<div class="form-group">
														Patient ID  <select name="pid" id="pid" onchange="return get_data();">
                                                                                                <option value="Select">Select</option>
                                                                                                <%


                                                                                                    DBQuery db=new DBQuery();
                                                                                                    ArrayList al=db.get_pid_list(hid);
                                                                                            ...
                                                                                            <div class="col-md-12">
													<div class="form-group">
														Report<input type="file" class="form-control" name="report" id="report"   >
													</div>
												</div>
                                                                                           
												<div class="col-md-12">
													<div class="form-group">
														<input type="submit" value="Upload Report" class="btn btn-primary">
