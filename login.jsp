							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Hospital Admin and Lab Assitant Login Here</h3>
                                                                                <h4><%=msg%></h4> <% session.removeAttribute("msg");%>
										<form action="./login" method="POST" id="contactForm" class="contactForm">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" class="form-control" name="name" id="hname" placeholder="User Name" required>
													</div>
												</div>
								...
								<div class="col-md-5 d-flex align-items-stretch">
									<div class="info-wrap bg-primary w-100 p-lg-5 p-4">
										<h3 class="mb-4 mt-md-4">Login for better and secured health care syatem </h3>
