							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Secured Health care using IPFS </h3>
										<h3 class="mb-4">Welcome PID <%=pid%> </h3>
										<h3 class="mb-4">Hospital ID <%=hid%></h3>
										<h3 class="mb-4">My Medical Report</h3>
										<h3 class="mb-4">Report ID <%=rid%></h3>
                                                                                <form action="./patient_download_report1" method="post">
      
                                                                                    <table>
<!--                                                                                        <tr><td>Enter The Password</td><td><input type="text" name="pass"/></td>-->
                                                                                         <td><input type="submit" name="submit" value="Decrypt"/></td></tr>
                                                                                    </table>
                                                                                 </form>
