							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">View Information</h3>
										<form action="./doctor_view_report" method="POST" id="contactForm" class="contactForm">
											<div class="row">
													...
													<div class="form-group">
														<input type="text" class="form-control" name="pname" id="pname" readonly  >
                                                                                            ...
                                                                                            <div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="pmob" id="pmob"   readonly>
													</div>
												</div>
                                                                                                <div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="pemail" id="pemail" readonly>
                                                                                            ...
                                                                                            <div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="pbgrp" id="pbgrp" readonly>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
