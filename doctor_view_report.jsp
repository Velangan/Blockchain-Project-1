							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4"> <%=pid%> Medical Report</h3>
										<h3 class="mb-4"> Report ID <%=rid%></h3>
										<h3 class="mb-4"> Please Check your Email</h3>
										<form action="./doctor_download_report1" method="POST" id="contactForm" class="contactForm">
											<div class="row">
