							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4"> My Medical Reports </h3>
										<table id="customers">
        <tr><td>Report ID</td><td>Uploaded By</td><td>Emp ID</td><td>Date and Time</td></tr>
        <%
            DBQuery db=new DBQuery();
            ArrayList al=db.get_my_details(hid, pid);
            ...
            %>
            <form action="./patient_download_report" method="post">
                <input type="hidden" name="rid" value="<%=arr[0]%>"/>
            <tr><td><%=arr[0]%></td><td><%=arr[1]%></td><td><%=arr[2]%></td><td><%=arr[3]%></td><td><input type="submit" name="submit" value="Download"/></td></tr>
            </form>
            <%
                }
            %>
