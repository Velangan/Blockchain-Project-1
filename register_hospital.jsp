...
<!--				<div class="order-lg-last">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="register_hospital.jsp" class="nav-link">Healthcare Signup</a></li>
	        	<li class="nav-item"><a href="doctor_login.jsp" class="nav-link">Doctors</a></li>
	        	<li class="nav-item"><a href="patient_login.jsp" class="nav-link">Patients</a></li>
	        	<li class="nav-item"><a href="login.jsp" class="nav-link">Healthcare Departments</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span><%=Logic.info.pname%> <i class="fa fa-chevron-right"></i></span></p>
							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Add Hospital Details</h3>
										<form action="./hospitalRegistration" method="POST" id="contactForm" class="contactForm">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" class="form-control" name="hname" id="hname" placeholder="Hospital Name" required>
													</div>
												</div>
												<div class="col-md-6"> 
													<div class="form-group">
												...
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="mob" id="mob" placeholder="Contact Number" pattern="[6789][0-9]{9}" title="Mobile No should start with 6/7/8/9 and 10 digit" required>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<textarea name="address" class="form-control" id="message" cols="30" rows="7" placeholder="Address"></textarea>
													</div>
												</div>
                                                                                            <div class="col-md-12">
													<div class="form-group">
								...
								<div class="col-md-5 d-flex align-items-stretch">
									<div class="info-wrap bg-primary w-100 p-lg-5 p-4">
										<h3 class="mb-4 mt-md-4">Register for better and secured health care syatem </h3>
					        	<div class="dbox w-100 d-flex align-items-start">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        			<span class="fa fa-map-marker"></span>
					        		</div>
					        		<div class="text pl-3">
						            <p><span>Etherium</span> Blockchain</p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>IPFS</span> Decentralized Storage</p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>Privacy</span> Data Privacy </p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>Website</span> <a href="#">ipfs.com</a></p>
						          </div>
					          </div>
				          </div>
								</div>
