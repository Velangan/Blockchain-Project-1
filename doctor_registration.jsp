							...
							<div class="row no-gutters">
								<div class="col-md-7 d-flex">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Add Doctor Details</h3>
										<form action="./DoctorRegistration" method="POST" id="contactForm" class="contactForm">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6"> 
													<div class="form-group">
														<input type="email" class="form-control" name="txtEmailID" id="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Insert valid email id" required>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="txtMobNo" id="mob" placeholder="Contact Number" pattern="[6789][0-9]{9}" title="Mobile No should start with 6/7/8/9 and 10 digit" required>
													</div>
												</div>
                                                                                                <div class="col-md-6">
													<div class="form-group">
														Gender <input type="radio" name="rdbtnGender" value="Male"/><label for="Male">Male</label>
                    <input type="radio" name="rdbtnGender" value="Female" style="margin-left: 96px;"/><label for="Female">Female</label>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<textarea name="txtAddress" class="form-control" id="message" cols="30" rows="7" placeholder="Address"></textarea>
                                                                                            ...
                                                                                            <div class="col-md-6">
													<div class="form-group">
														Qualifications <input type="text" value="M.B.B.S" readonly="true" name="txtMBBS"/>
                                                                            <select name="lstPG">
                                                                                <option value="NoPG">--None--</option>
